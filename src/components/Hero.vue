                ...
                <div class="col-lg-6 col-md-11">
                    <div class="hero-content-three rpt-15 rmb-75">
                        <h1 class="mb-15 wow fadeInUp delay-0-2s">
                            Transforme seu atendimento com o StarChats
                        </h1>
                        <p class="wow fadeInUp delay-0-4s">
                            Centralize conversas, equipes e canais em um único CRM multicanal.
                        </p>
                        <RouterLink to="/register" class="theme-btn style-two mt-30">
                            Quero testar grátis <i class="fas fa-arrow-right"></i>
                        </RouterLink>
                    </div>
                </div>
